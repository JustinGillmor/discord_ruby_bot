...
bot = Discordrb::Commands::CommandBot.new token: 'ODg4MTc5NDMwMzAyODEwMjE0.YUO7jQ.NTu2S0WI2RlPXBbRPXuXXZilUzI', prefix: '!'
...
bot.command(:exit, help_available: false) do |event|
  ...
  break unless event.user.id == 512641054399397899 # Replace number with your ID
